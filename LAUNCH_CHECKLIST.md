# MFT : My Flourish Tracker — Store Launch Checklist
...
| Item | Detail |
|------|--------|
| Store display name | `MFT : My Flourish Tracker` (25 chars; fits Apple/Google 30-char name limit) |
| Full brand expansion | `MFT (My Flourish Tracker)` for long-form copy where length is not constrained |
...
2. App name: `MFT : My Flourish Tracker`
...
- [ ] **App name** — `MFT : My Flourish Tracker` (25 chars; max 30 chars)
