...
const styles = StyleSheet.create({
  ...
  heroPercentValue: { fontSize: 24, fontFamily: TYPOGRAPHY.family.bold, color: '#FFF' },
  heroPercentLabel: { fontSize: 9, fontFamily: TYPOGRAPHY.family.medium, color: 'rgba(255,255,255,0.8)', letterSpacing: 0.5 },
  heroMainValue: { flexDirection: 'row', alignItems: 'baseline', marginTop: 8 },
  heroMl: { fontSize: 48, fontFamily: TYPOGRAPHY.family.regular, color: '#FFF', letterSpacing: -1 },
  heroMlUnit: { fontSize: 18, fontFamily: TYPOGRAPHY.family.regular, color: 'rgba(255,255,255,0.9)', marginLeft: 4 },
  ...
  heroRemaining: { fontSize: 12, color: 'rgba(255,255,255,0.9)', fontFamily: TYPOGRAPHY.family.medium },
  ...
  paceText: { fontSize: 11, fontFamily: TYPOGRAPHY.family.semibold, color: '#0284C7' },
  ...
  statValue: { fontSize: 20, fontFamily: TYPOGRAPHY.family.bold, color: COLORS.text.primary },
  statLabel: { fontSize: 10, fontFamily: TYPOGRAPHY.family.medium, color: COLORS.text.tertiary, marginTop: 2 },
  ...
  weeklyBarTitle: { fontSize: 15, fontFamily: TYPOGRAPHY.family.semibold, color: COLORS.text.primary },
  weeklyBarStats: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  weeklyBarTotal: { fontSize: 18, fontFamily: TYPOGRAPHY.family.bold, color: COLORS.text.primary },
  ...
  comparisonText: { fontSize: 11, fontFamily: TYPOGRAPHY.family.semibold },
  ...
  goalLineLabel: { fontSize: 9, fontFamily: TYPOGRAPHY.family.semibold, color: COLORS.success, marginLeft: 6 },
  ...
  weeklyBarLabel: { fontSize: 10, fontFamily: TYPOGRAPHY.family.semibold, color: COLORS.text.tertiary, marginTop: 6 },
  weeklyBarLabelToday: { color: COLORS.primary, fontFamily: TYPOGRAPHY.family.bold },
  ...
  tipContent: { flex: 1 },
  tipTitle: { fontSize: 14, fontFamily: TYPOGRAPHY.family.semibold, color: COLORS.text.primary, marginBottom: 2 },
  tipMessage: { fontSize: 13, fontFamily: TYPOGRAPHY.family.regular, color: COLORS.text.secondary, lineHeight: 18 },
  ...
  consistencyTitle: { fontSize: 15, fontFamily: TYPOGRAPHY.family.semibold, color: COLORS.text.primary },
  ...
  consistencyBadgeText: { fontSize: 11, fontFamily: TYPOGRAPHY.family.semibold, color: COLORS.primary },
  ...
  consistencyDotLabel: { fontSize: 10, fontFamily: TYPOGRAPHY.family.semibold, color: COLORS.text.tertiary },
  consistencyDotLabelToday: { color: COLORS.primary, fontFamily: TYPOGRAPHY.family.bold },
  ...
  consistencyPctText: { fontSize: 12, fontFamily: TYPOGRAPHY.family.semibold, color: COLORS.text.secondary, minWidth: 80, textAlign: 'right' },
  ...
  intensityTitle: { fontSize: 15, fontFamily: TYPOGRAPHY.family.semibold, color: COLORS.text.primary },
  ...
  intensityPeakText: { fontSize: 11, fontFamily: TYPOGRAPHY.family.semibold, color: '#8B5CF6' },
  intensityBars: { gap: 12 },
  intensityBarContainer: { gap: 6 },
  intensityBarHeader: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  intensityBarLabel: { flex: 1, fontSize: 12, fontFamily: TYPOGRAPHY.family.medium, color: COLORS.text.secondary },
  intensityBarValue: { fontSize: 12, fontFamily: TYPOGRAPHY.family.bold, color: COLORS.text.primary, minWidth: 36, textAlign: 'right' },
  ...
  varietyText: { fontSize: 10, fontFamily: TYPOGRAPHY.family.semibold, color: COLORS.success },
  ...
  recommendationTitle: { fontSize: 15, fontFamily: TYPOGRAPHY.family.semibold, color: COLORS.text.primary, marginBottom: 4 },
  recommendationMessage: { fontSize: 13, fontFamily: TYPOGRAPHY.family.regular, color: COLORS.text.secondary, lineHeight: 18 },
  recommendationAction: { flexDirection: 'row', alignItems: 'center', gap: 4, marginTop: 10, alignSelf: 'flex-start' },
  recommendationActionText: { fontSize: 13, fontFamily: TYPOGRAPHY.family.semibold, color: COLORS.primary },

  // Section
  sectionContainer: { paddingHorizontal: 16, marginTop: 24 },
  sectionHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 },
  sectionTitle: { fontSize: 18, fontFamily: TYPOGRAPHY.family.semibold, color: COLORS.text.primary },
