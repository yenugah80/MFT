...
const styles = StyleSheet.create({
  ...
  loadingText: { fontSize: 14, color: TEXT.secondary },
  errorText: { fontSize: 14, color: TEXT.secondary, textAlign: "center" },
  ...
  lifecycleText: { fontSize: 12, fontWeight: "600", color: "#FFF" },
  ...
  gaugeLabel: { fontSize: 12, color: TEXT.tertiary, marginTop: -4 },
  bmiStatusBadge: { paddingHorizontal: 16, paddingVertical: 6, borderRadius: 20, marginTop: 8 },
  bmiStatusText: { fontSize: 14, fontWeight: "600" },
  bmiAdvice: { fontSize: 13, color: TEXT.secondary, textAlign: "center", marginTop: 8 },
  ...
  statCardSmall: {},
  statValue: { fontSize: 20, fontWeight: "700", color: TEXT.primary, marginTop: 4 },
  statValueSmall: { fontSize: 18 },
  statUnit: { fontSize: 10, color: TEXT.tertiary },
  statLabel: { fontSize: 11, color: TEXT.secondary, marginTop: 2 },
