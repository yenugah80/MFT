...
export const GOALS = [
  ...
  },
  {
    ...
    color: '#087F9B',
    gradientStart: '#087F9B',
    gradientEnd: '#066178',
  },
];

// Checklist items shown on step 2 — users check every option that applies
// to their lifestyle, and their combined weight determines which
// ACTIVITY_LEVELS bucket (below) is auto-selected for TDEE math.
export const ACTIVITY_CHECKLIST = [
  {
    id: 'desk_job',
    label: 'Desk job / mostly sitting',
    description: 'Office work, studying, driving',
    icon: 'body-outline',
    color: '#6B94B3',
    weight: 0,
  },
  {
    id: 'on_feet_job',
    label: 'On my feet at work',
    description: 'Retail, teaching, hospitality',
    icon: 'walk-outline',
    color: '#5FA88C',
    weight: 1,
  },
  {
    ...
    description: 'Manual labor, trades, warehouse',
  ...
  {
    id: 'daily_movement',
    label: 'Walk or cycle daily',
    description: 'Commuting, errands, dog walks',
  ...
  {
    id: 'exercise_light',
    label: 'Exercise 1-2 days a week',
    description: 'Gym, jogging, yoga, sports',
  ...
  },
  {
    ...
    label: 'Exercise 3-5 days a week',
    description: 'Consistent training routine',
  ...
  {
    id: 'exercise_intense',
    label: 'Intense training 6-7 days a week',
    description: 'Daily workouts or two-a-days',
    icon: 'flash-outline',
    color: '#C1642B',
    weight: 3,
  },
  {
    id: 'competitive_sport',
    label: 'Competitive sport or athlete',
    description: 'Race training, in-season team sport',
    icon: 'trophy-outline',
    color: '#7C3AED',
    weight: 2,
  },
...
export const ONBOARDING_COPY = {
  step1: {
    title: "What's your\nprimary goal?",
    subtitle: "This helps us create a plan that's perfect for you.",
  ...
  step2: {
    ...
    activityHint: 'Check everything that applies — we\'ll work out your activity level from the combination',
    backBtn: 'Back',
